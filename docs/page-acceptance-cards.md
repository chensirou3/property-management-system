...
| 目标路由 | `/main/487` |
| 当前目录状态 | G10 最终闭合；达到 L1 / L2，完成矩阵与四态结论见 `acceptance-report.md` |
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#01；三视口基线 `page-01-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
...
| 当前目录状态 | G10 最终闭合；达到 L1 / L2 / L3，完成矩阵与四态结论见 `acceptance-report.md` |
...
- 业务假设：组织层级以当前企业为根。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#02；三视口基线 `page-02-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：按钮权限与数据范围分开配置。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#03；三视口基线 `page-03-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#04；三视口基线 `page-04-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#05；三视口基线 `page-05-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：当前关系与历史关系分层展示。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#06；三视口基线 `page-06-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：证件号、手机号默认脱敏。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#07；三视口基线 `page-07-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#08；三视口基线 `page-08-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#09；三视口基线 `page-09-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#10；三视口基线 `page-10-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#11；三视口基线 `page-11-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#12；三视口基线 `page-12-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：欠费不含已全额冲正账单。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#13；三视口基线 `page-13-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#14；三视口基线 `page-14-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：G6 按成功交易发生日归集收款/冲正，锁定后所属交易不可直接冲正；法定口径仍待财务签字。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#15；三视口基线 `page-15-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#16；三视口基线 `page-16-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#17；三视口基线 `page-17-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#18；三视口基线 `page-18-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#19；三视口基线 `page-19-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：网格可分层并绑定楼栋/房产。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#20；三视口基线 `page-20-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#21；三视口基线 `page-21-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#22；三视口基线 `page-22-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#23；三视口基线 `page-23-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：异常读数需复核后才允许审核。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#24；三视口基线 `page-24-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：折扣策略按版本和生效期保留历史；应用到账单时生成可审批调账证据。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#25；三视口基线 `page-25-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#26；三视口基线 `page-26-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：交易日期按支付成功时间归属。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#27；三视口基线 `page-27-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：退款和冲正通过原交易号关联。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#28；三视口基线 `page-28-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：已日结交易冲正产生反向分录。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#29；三视口基线 `page-29-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#30；三视口基线 `page-30-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#31；三视口基线 `page-31-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：收缴与清欠两套分母独立展示。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#32；三视口基线 `page-32-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：按交易分摊明细展示费用项目。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#33；三视口基线 `page-33-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：余额由不可变预收分录汇总。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#34；三视口基线 `page-34-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：户数按房产-费用项目去重。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#35；三视口基线 `page-35-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#36；三视口基线 `page-36-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：系统保留项不可删除，只可停用。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#37；三视口基线 `page-37-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#38；三视口基线 `page-38-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：密钥只写不回显，默认模拟模式。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#39；三视口基线 `page-39-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#40；三视口基线 `page-40-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#41；三视口基线 `page-41-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#42；三视口基线 `page-42-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#43；三视口基线 `page-43-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 业务假设：折扣金额与账单优惠分录可对账。
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#44；三视口基线 `page-44-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#45；三视口基线 `page-45-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：已按 L3 完成关系、数量、规则或金额对账；具体口径与合成边界见最终验收报告。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#46；三视口基线 `page-46-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#47；三视口基线 `page-47-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#48；三视口基线 `page-48-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
...
- 结构证据：目标扫描索引 PMS3页面与接口证据附录#49；三视口基线 `page-49-{1366x768,1440x900,1920x1080}-win32.png`；49/49 路由烟雾和 147/147 视觉纯比对通过。
- 功能证据：最终完成矩阵、API/权限/失败路径与领域主旅程见 `acceptance-report.md`、`requirements-traceability.md` 和对应 G3—G10 集成/E2E 测试。
- 数据证据：本页目标为 L2；内部合成/模拟数据可重复，真实业务口径和外部数据不伪装为已完成。
- 外部边界：最终四态分类见 `acceptance-report.md`；生产数据、支付、发票、银行、通知、IoT、Java110 或正式 UAT 缺少外部授权时保持“待外部资料”。
