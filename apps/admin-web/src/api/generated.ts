...
export interface paths {
    ...
    "/api/v1/dashboard/configurations/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/receipt-print-jobs": {
        ...
        get: operations["receiptPrints"];
        put?: never;
        post: operations["createReceiptPrint"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/integrations/outbox-events:simulate": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/integrations/outbox-events:drain-simulated": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/integrations/outbox-events/{id}:simulate-delivery": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/integrations/dead-letters/{id}:replay": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/integrations/callbacks/{adapterCode}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/integrations/adapters/{adapterCode}:test": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/dashboard/configurations:reorder": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/dashboard/configurations:publish": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/report-jobs/{id}/artifact": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/receipt-print-jobs/{id}/artifact": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["receiptArtifact"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        ScopeCommand: {
            communityId: string;
            roleCode: string;
            widgets: components["schemas"]["VersionReference"][];
        };
        VersionReference: {
            id: string;
            /** Format: int64 */
...
export interface operations {
    ...
    createExport: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateExportJob"];
            };
        };
        responses: {
            /** @description OK */
    ...
    createReceiptPrint: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateReceiptPrintJob"];
            };
        };
        responses: {
            /** @description OK */
    ...
    createNotification: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateNotificationBatch"];
            };
        };
        responses: {
            /** @description OK */
    ...
    createOutbox: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SimulatedOutboxRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    deliver: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SimulatedDeliveryRequest"];
            };
        };
        responses: {
            /** @description OK */
    ...
    reorder: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ScopeCommand"];
            };
        };
        responses: {
            /** @description OK */
